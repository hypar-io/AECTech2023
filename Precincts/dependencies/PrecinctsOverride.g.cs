...
{
	/// <summary>
	/// Override metadata for PrecinctsOverride
	/// </summary>
	public partial class PrecinctsOverride : IOverride
	{
        public static string Name = "Precincts";
	...
	public static class PrecinctsOverrideExtensions
    {
		/// <summary>
        /// Apply Precincts edit overrides to a collection of existing elements
        /// </summary>
        /// <param name="overrideData">The Precincts Overrides to apply</param>
        ...
        public static List<T> Apply<T>(
            this IList<PrecinctsOverride> overrideData,
            IEnumerable<T> existingElements,
            Func<T, PrecinctsIdentity, bool> identityMatch,
            Func<T, PrecinctsOverride, T> modifyElement) where T : Element
        {
        ...
        /// </summary>
        /// <param name="existingElements">A collection of existing elements to which to apply the overrides.</param>
        /// <param name="overrideData">The Precincts Overrides to apply — typically `input.Overrides.Precincts`</param>
        /// <param name="identityMatch">A function returning a boolean which indicates whether an element is a match for an override's identity.</param>
        /// <param name="modifyElement">A function to modify a matched element, returning the modified element.</param>
        /// <typeparam name="T">The element type this override applies to. Should match the type(s) in the override's context.</typeparam>
        /// <returns>A collection of elements, including unmodified and modified elements from the supplied collection.</returns>
        public static void ApplyOverrides<T>(
            ...
            IList<PrecinctsOverride> overrideData,
            Func<T, PrecinctsIdentity, bool> identityMatch,
            Func<T, PrecinctsOverride, T> modifyElement
            ) where T : Element
        {
        ...
        /// </summary>
        /// <param name="edits">The collection of edit overrides (Overrides.Precincts)</param>
        /// <param name="additions">The collection of add overrides (Overrides.Additions.Precincts)</param>
        /// <param name="removals">The collection of remove overrides (Overrides.Removals.Precincts)</param>        /// <param name="identityMatch">A function returning a boolean which indicates whether an element is a match for an override's identity.</param>
        ...
        public static List<T> CreateElements<T>(
            this IList<PrecinctsOverride> edits,
            IList<PrecinctsOverrideAddition> additions,
            IList<PrecinctsOverrideRemoval> removals,            Func<PrecinctsOverrideAddition, T> createElement,
            Func<T, PrecinctsIdentity, bool> identityMatch,
            Func<T, PrecinctsOverride, T> modifyElement,
