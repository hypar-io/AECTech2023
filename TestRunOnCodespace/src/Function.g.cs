...
namespace TestRunOnCodespace
{
    public class Function
    {
        ...
        private UrlModelStore<TestRunOnCodespaceInputs> store;

        public async Task<TestRunOnCodespaceOutputs> Handler(TestRunOnCodespaceInputs args)
        {
            ...
            if(this.store == null)
            {
                this.store = new UrlModelStore<TestRunOnCodespaceInputs>();
            }
            

            var l = new InvocationWrapper<TestRunOnCodespaceInputs,TestRunOnCodespaceOutputs> (store, TestRunOnCodespace.Execute);
