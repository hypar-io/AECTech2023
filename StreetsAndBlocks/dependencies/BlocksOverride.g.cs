...
{
	/// <summary>
	/// Override metadata for BlocksOverride
	/// </summary>
	public partial class BlocksOverride : IOverride
	{
	...
	public static class BlocksOverrideExtensions
    {
		/// <summary>
        /// Apply Blocks edit overrides to a collection of existing elements
        /// </summary>
        /// <param name="overrideData">The Blocks Overrides to apply</param>
        ...
        public static List<T> Apply<T>(
            this IList<BlocksOverride> overrideData,
            IEnumerable<T> existingElements,
            Func<T, BlocksIdentity, bool> identityMatch,
            Func<T, BlocksOverride, T> modifyElement) where T : Element
        {
        ...
        /// </summary>
        /// <param name="existingElements">A collection of existing elements to which to apply the overrides.</param>
        /// <param name="overrideData">The Blocks Overrides to apply — typically `input.Overrides.Blocks`</param>
        /// <param name="identityMatch">A function returning a boolean which indicates whether an element is a match for an override's identity.</param>
        /// <param name="modifyElement">A function to modify a matched element, returning the modified element.</param>
        /// <typeparam name="T">The element type this override applies to. Should match the type(s) in the override's context.</typeparam>
        /// <returns>A collection of elements, including unmodified and modified elements from the supplied collection.</returns>
        public static void ApplyOverrides<T>(
            ...
            IList<BlocksOverride> overrideData,
            Func<T, BlocksIdentity, bool> identityMatch,
            Func<T, BlocksOverride, T> modifyElement
            ) where T : Element
        {
        ...
        /// </summary>
        /// <param name="edits">The collection of edit overrides (Overrides.Blocks)</param>
        /// <param name="additions">The collection of add overrides (Overrides.Additions.Blocks)</param>
        /// <param name="removals">The collection of remove overrides (Overrides.Removals.Blocks)</param>        /// <param name="identityMatch">A function returning a boolean which indicates whether an element is a match for an override's identity.</param>
        ...
        public static List<T> CreateElements<T>(
            this IList<BlocksOverride> edits,
            IList<BlocksOverrideAddition> additions,
            IList<BlocksOverrideRemoval> removals,            Func<BlocksOverrideAddition, T> createElement,
            Func<T, BlocksIdentity, bool> identityMatch,
            Func<T, BlocksOverride, T> modifyElement,
