...
{
	/// <summary>
	/// Override metadata for StreetsOverride
	/// </summary>
	public partial class StreetsOverride : IOverride
	{
        public static string Name = "Streets";
	...
	public static class StreetsOverrideExtensions
    {
		/// <summary>
        /// Apply Streets edit overrides to a collection of existing elements
        /// </summary>
        /// <param name="overrideData">The Streets Overrides to apply</param>
        ...
        public static List<T> Apply<T>(
            this IList<StreetsOverride> overrideData,
            IEnumerable<T> existingElements,
            Func<T, StreetsIdentity, bool> identityMatch,
            Func<T, StreetsOverride, T> modifyElement) where T : Element
        {
        ...
        /// </summary>
        /// <param name="existingElements">A collection of existing elements to which to apply the overrides.</param>
        /// <param name="overrideData">The Streets Overrides to apply — typically `input.Overrides.Streets`</param>
        /// <param name="identityMatch">A function returning a boolean which indicates whether an element is a match for an override's identity.</param>
        /// <param name="modifyElement">A function to modify a matched element, returning the modified element.</param>
        /// <typeparam name="T">The element type this override applies to. Should match the type(s) in the override's context.</typeparam>
        /// <returns>A collection of elements, including unmodified and modified elements from the supplied collection.</returns>
        public static void ApplyOverrides<T>(
            ...
            IList<StreetsOverride> overrideData,
            Func<T, StreetsIdentity, bool> identityMatch,
            Func<T, StreetsOverride, T> modifyElement
            ) where T : Element
        {
        ...
        /// </summary>
        /// <param name="edits">The collection of edit overrides (Overrides.Streets)</param>
        /// <param name="additions">The collection of add overrides (Overrides.Additions.Streets)</param>
        /// <param name="removals">The collection of remove overrides (Overrides.Removals.Streets)</param>        /// <param name="identityMatch">A function returning a boolean which indicates whether an element is a match for an override's identity.</param>
        ...
        public static List<T> CreateElements<T>(
            this IList<StreetsOverride> edits,
            IList<StreetsOverrideAddition> additions,
            IList<StreetsOverrideRemoval> removals,            Func<StreetsOverrideAddition, T> createElement,
            Func<T, StreetsIdentity, bool> identityMatch,
            Func<T, StreetsOverride, T> modifyElement,
