...
namespace StreetsAndBlocks
{
    public class Function
    {
        ...
        private IModelStore<StreetsAndBlocksInputs> store;

        public async Task<StreetsAndBlocksOutputs> Handler(StreetsAndBlocksInputs args, ILambdaContext context)
        {
            ...
            { 
                ...
                {
                    this.store = new S3ModelStore<StreetsAndBlocksInputs>(RegionEndpoint.GetBySystemName("us-west-1"));
                }
                else
                {
                    this.store = new UrlModelStore<StreetsAndBlocksInputs>();
                }
            }

            var l = new InvocationWrapper<StreetsAndBlocksInputs,StreetsAndBlocksOutputs> (store, StreetsAndBlocks.Execute);
