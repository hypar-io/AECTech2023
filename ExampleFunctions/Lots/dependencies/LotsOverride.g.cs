...
{
	/// <summary>
	/// Override metadata for LotsOverride
	/// </summary>
	public partial class LotsOverride : IOverride
	{
        public static string Name = "Lots";
	...
	public static class LotsOverrideExtensions
    {
		/// <summary>
        /// Apply Lots edit overrides to a collection of existing elements
        /// </summary>
        /// <param name="overrideData">The Lots Overrides to apply</param>
        ...
        public static List<T> Apply<T>(
            this IList<LotsOverride> overrideData,
            IEnumerable<T> existingElements,
            Func<T, LotsIdentity, bool> identityMatch,
            Func<T, LotsOverride, T> modifyElement) where T : Element
        {
        ...
        /// </summary>
        /// <param name="existingElements">A collection of existing elements to which to apply the overrides.</param>
        /// <param name="overrideData">The Lots Overrides to apply — typically `input.Overrides.Lots`</param>
        /// <param name="identityMatch">A function returning a boolean which indicates whether an element is a match for an override's identity.</param>
        /// <param name="modifyElement">A function to modify a matched element, returning the modified element.</param>
        /// <typeparam name="T">The element type this override applies to. Should match the type(s) in the override's context.</typeparam>
        /// <returns>A collection of elements, including unmodified and modified elements from the supplied collection.</returns>
        public static void ApplyOverrides<T>(
            ...
            IList<LotsOverride> overrideData,
            Func<T, LotsIdentity, bool> identityMatch,
            Func<T, LotsOverride, T> modifyElement
            ) where T : Element
        {
        ...
        /// </summary>
        /// <param name="edits">The collection of edit overrides (Overrides.Lots)</param>
        /// <param name="additions">The collection of add overrides (Overrides.Additions.Lots)</param>
        /// <param name="removals">The collection of remove overrides (Overrides.Removals.Lots)</param>        /// <param name="identityMatch">A function returning a boolean which indicates whether an element is a match for an override's identity.</param>
        ...
        public static List<T> CreateElements<T>(
            this IList<LotsOverride> edits,
            IList<LotsOverrideAddition> additions,
            IList<LotsOverrideRemoval> removals,            Func<LotsOverrideAddition, T> createElement,
            Func<T, LotsIdentity, bool> identityMatch,
            Func<T, LotsOverride, T> modifyElement,
